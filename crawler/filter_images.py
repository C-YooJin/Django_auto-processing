...
def filter(keyword, save, save_dir):
    # device setting
    device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')

    # imagenet class index.json path
    json_path = '/Users/user/Downloads/imagenet/imagenet_class_index.json'
    source_image_dir = save
    ...
    target_idx = class2idx[target_class.lower()]
    is_target = []
...
if __name__ == '__main__':
    ...
    parser.add_argument('--json_path', type=str, default='/Users/user/Downloads/imagenet/imagenet_class_index.json')
    parser.add_argument('--source_image_dir', type=str, default='/Users/user/Downloads/Google_crawling/최유진_KR5212_dog/',
                        help='unfiltered image directory')
    parser.add_argument('--target_image_dir', type=str, default='/Users/user/Downloads/Google_crawling/최유진_KR5212_dog/filtered',
